...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; Android {a}; SAMSUNG SM-G900P) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	ugen2.append(uaku)

for t in range(10000):
	rr = random.randint
	brayen1=f'Mozilla/5.0 (Linux; Android {str(rr(7,12))}; SM-G900P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36'
	brayen2=f'Mozilla/5.0 (Linux; Android {str(rr(7,12))}; SM-J530F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36'
	brayen3=f'Mozilla/5.0 (Linux; Android {str(rr(7,12))}; SM-M236B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36'
